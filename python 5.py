...
l1.insert(2, "cars")
print(l1)
 [11:31 am, 15/03/2024] Ramesh Reddy Ksrm: # ? to delete element from list
l1 = [6, 7, 8, 9, 0, 8.89, -5, 0.78]
...
l2 = ["p", "o", "t", 34]
print(l1+l2)
[11:31 am, 15/03/2024] Ramesh Reddy Ksrm: #* deep copy --> used to copy the list with nested list
import copy
l1 = [8, 9, 0,[5, 6],[3, 2, 1]]
...
print(l1)
print(l2)
[11:31 am, 15/03/2024] Ramesh Reddy Ksrm: # ? sort --> arrange elements in list in ascending or descending order
l1 = [9, 7, 45, 0, -6, 5, 12]
...
[11:31 am, 15/03/2024] Ramesh Reddy Ksrm: # ? combine these ["p", "o", 'y'], [8, 't'] lists in l1 to ["p", "o", 'y',8, 't']
l1[-2].extend(l1[-1])
l1.pop(-1)
print(l1)
